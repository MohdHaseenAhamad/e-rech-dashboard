...
<!-- Mirrored from www.sarkarinewz.com/recharge/dashboard.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Feb 2023 13:32:10 GMT -->
<!-- Added by HTTrack -->
...
<i class="fa fa-ellipsis-v fa-w-6"></i>
        ...
        <div class="app-header__content">
            <div class="app-header-left">
                ...
                <ul class="header-megamenu nav">
                    ...
                    <li class="btn-group nav-item">
                        <a class="nav-link" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-wallet"></i>&nbsp;Load
                            Wallet
                        </a>
                        <div tabindex="-1" role="menu" aria-hidden="true" class="rm-pointers dropdown-menu">
                            <div class="dropdown-menu-header">
                                <h5 class="menu-header-title text-dark p-1">Wallet Load</h5>
                                <form>
                                    ...
                                    <button class="btn-wide btn-shadow btn btn-danger btn-sm ml-2">Load</button>
                                </form>
                    </li>
                    <li class="dropdown nav-item">
                        <a aria-haspopup="true" data-toggle="dropdown" class="nav-link" aria-expanded="false">
                            <i class="nav-link-icon fa fa-bell" style="color:#000;"></i> Notification
                        ...
                        <div tabindex="-1" role="menu" aria-hidden="true"
                            ...
                            <div class="dropdown-menu-header">
                                <div class="dropdown-menu-header-inner ">
                                    <h5 class="menu-header-title text-dark">App Notify</h5>
                                    <form>
                                        <div class="form-group p-2">
                                            <label class="text-dark">Notification Type</label>
                                        ...
                                        <button class="btn-wide btn-shadow btn btn-danger btn-sm ml-2">Submit</button>
                                    </form>
                    </li>
                </ul>
            </div>
            <div class="app-header-right">
                                    ...
                                    <div tabindex="-1" role="menu" aria-hidden="true"
                                                ...
                                                <div class="menu-header-content text-left">
                                                    <div class="widget-content p-0">
                                                        <div class="widget-content-wrapper">
                                                            ...
                                                            <div class="widget-content-left">
                                                                <div class="widget-heading">Member Type- Admin</div>
                                        ...
                                        <ul class="nav flex-column">
                                            ...
                                            <li class="nav-item-btn text-center nav-item">
                                                <button class="btn-wide btn btn-primary btn-sm"> Logout</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                ...
                <div class="header-btn-lg d-none">
            ...
            <div class="scrollbar-sidebar">
                <div class="app-sidebar__inner">
                    <ul class="vertical-nav-menu">
                        ...
                        <li>
                            <a href="#">
                                <i class="metismenu-icon pe-7s-refresh-2"></i>Live Recharge
                            </a>
                        </li>

                        <li class="mm-active">
                            <a href="#">
                                <i class="metismenu-icon pe-7s-hourglass"></i>Commision Manager
                                <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                            </a>
                            <ul>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Commission Slab
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="mm-active">
                            <a href="#">
                                <i class="metismenu-icon pe-7s-user"></i>User Management
                                <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                            </a>
                            <ul>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Reseller Admin
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Api Partner
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Super Partner
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Distributor
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Retailer
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Active
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>In-active
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="mm-active">
                            <a href="#">
                                <i class="metismenu-icon pe-7s-user"></i>Fund
                                <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                            </a>
                            <ul>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Transfer/Return
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Request
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Load Wallet
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Request Report
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>All Fund Report
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Report Statement
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="mm-active">
                            <a href="#">
                                <i class="metismenu-icon pe-7s-file"></i>Reports
                                <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                            </a>
                            <ul>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Mobile Recharge
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Dth Recharge
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Uti
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Uti Statement
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li>
                            <a href="#">
                                <i class="metismenu-icon pe-7s-rocket"></i>Wallet Statement
                            </a>
                        </li>

                        <li>
                            <a href="#">
                                <i class="metismenu-icon pe-7s-rocket"></i>Send Notification
                            </a>
                        </li>

                        <li>
                            <a href="#">
                                <i class="metismenu-icon pe-7s-plug"></i>Switch Api
                            </a>
                        </li>

                        <li>
                            <a href="#">
                                <i class="metismenu-icon pe-7s-config"></i>Operator manager
                            </a>
                        </li>
                        ...
                        <li class="mm-active">
                            <a href="#">
                                <i class="metismenu-icon pe-7s-global"></i>Manage Website
                                <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                            </a>
                            <ul>
                                <li>
                        ...
                        <li>
                            <a href="#">
                                <i class="metismenu-icon pe-7s-paper-plane"></i>Manage Compalins
                            </a>
                        </li>

                        <li>
                            <a href="#">
                                <i class="metismenu-icon pe-7s-note"></i>Complaints Subject
                            </a>
                        </li>

                        <li>
                            <a href="#">
                                <i class="metismenu-icon pe-7s-key"></i>Set T-pin
                            </a>
                        </li>

                        <li>
                            <a href="#">
                                <i class="metismenu-icon pe-7s-timer"></i>Manage Fee
                            </a>
                        </li>

                        <li class="mm-active">
                            <a href="#">
                                <i class="metismenu-icon pe-7s-tools"></i>Role & Permission
                                <i class="metismenu-state-icon pe-7s-angle-down caret-left"></i>
                            </a>
                            <ul>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Add/View Roles
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Manage Permissions
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Company Manager
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Profile Manager
                                    </a>
                                </li>
                            </ul>
                        </li>
                        ...
                        <li class="mm-active">
                            ...
                            <ul>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Setup Payment gateway
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Setup Sms Api
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>E-mail Setting
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Bank Account
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Portal Setting
                                    </a>
                                </li>
                                <li>
                                    <a href="index-2.html">
                                        <i class="metismenu-icon"></i>Slider Setting
                                    </a>
                                </li>
                            </ul>
                        </li>
                                                    ...
                                                    <div class="widget-progress-wrapper">
                                                        <div class="progress-bar-sm progress-bar-animated-alt progress">
                                                            <div class="progress-bar bg-primary" role="progressbar"
                                                                 ...
                                                                 aria-valuemax="100" style="width: 43%;">
                                                            </div>
                                                        </div>
...
<!-- Mirrored from www.sarkarinewz.com/recharge/dashboard.php by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 25 Feb 2023 13:32:14 GMT -->
</html>
